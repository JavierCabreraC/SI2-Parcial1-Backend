...
from .views import (UsuarioListView, UsuarioCreateView, PersonalCreateView, ClienteCreateView, 
                    PersonalListView, PersonalDetailView, ClienteListView,ClienteDetailView,
)
